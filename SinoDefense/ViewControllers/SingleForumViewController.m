...
- (void)viewDidLoad
{
    ...
    [self.tableView registerClass:[TopicItemCell class] forCellReuseIdentifier:@"TopicItemCell"];
    self.tableView.separatorStyle = UITableViewCellSeparatorStyleSingleLine;
...
-(void) postTopic{
    ...
    PostViewController *pvc =  (PostViewController*)[storyboard instantiateViewControllerWithIdentifier:@"PostView"];
