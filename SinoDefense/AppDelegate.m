...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CategoriesViewController *masterViewController = [[CategoriesViewController alloc] initWithStyle:UITableViewStylePlain];
    
    CBLoginViewController *CBLoginVC = [[CBLoginViewController alloc] initWithNibName:@"CBLoginViewController" bundle:nil];
    CBPostViewController *CBPostVC = [[CBPostViewController alloc] initWithNibName:@"CBPostViewController" bundle:nil];
    sidebarMenuVC.menuItemViewControllers = [[NSArray alloc] initWithObjects:masterViewController, settingsVC, meVC, loginVC,webVC,CBLoginVC,CBPostVC,nil];

    sidebarMenuVC.menuItemNames = [[NSArray alloc] initWithObjects:@"Categorize", @"Settings", @"Me", @"Login", @"WebLogin", @"anotehr login",@"another post",nil];
