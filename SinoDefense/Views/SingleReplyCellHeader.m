...
-(void)configurationLocation
{
    ...
    _upperSeparator.frame = CGRectMake(0, 0, Getwidth, 1);
    ...
    _lowerSeparator.frame = CGRectMake(0, HEAD_IAMGE_HEIGHT, Getwidth, 1);
...
- (void)replyButtonClick:(id)sender
{
    ...
    UIStoryboard *storyboard =[UIStoryboard storyboardWithName:@"PostView" bundle:[NSBundle mainBundle]];
    PostViewController *rvc =  (PostViewController*)[storyboard instantiateViewControllerWithIdentifier:@"PostView"];
